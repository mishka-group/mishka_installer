defmodule MishkaInstaller do
  ...
  **Note: If you want your plugin to execute automatically,
  ...
  > **The installer is in beta mode, use it carefully and some of its functionality
  > may not work in the Elixir `release`.**
  ...
  **TRX**:
  ...
  @doc """
  Helper function to specify project path and return the current Mix environment.
