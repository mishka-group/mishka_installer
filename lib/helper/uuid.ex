defmodule MishkaInstaller.Helper.UUID do
  @moduledoc """
  ...
  The UUID is returned as a 36-character lowercase hex string (`t:t/0`). The implementation is
  adapted from `Ecto.UUID` (Apache-2.0).
  """

  @typedoc "A hex-encoded version 4 UUID string."
  @type t :: <<_::288>>

  @typedoc "A raw 128-bit UUID binary."
  @type raw :: <<_::128>>
